...
const defaultDiscounts: Omit<import('./types').Discount, never>[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://m.media-amazon.com/images/I/91L8rWSwkCL._AC_SL1500_.jpg',
    detectedAt: NOW.toISOString(), predictedDiscount: false, confidence: 99, sector: 'Electrónica',
    country: 'Ecuador', freeShipping: true,
...

  {
    ...
    description: 'Exynos 2500 3nm, Dynamic AMOLED 2X 6.7" 120Hz 2600 nits, cámara 50MP OIS + tele 3×, batería 4700mAh 45W, IP68. $3,999,990 COP. 0% interés + Envío gratis + Seguro incluido.',
  ...
  },
  {
    ...
    description: 'Dimensity 7300 Energy 5G, pOLED 6.67" 144Hz 1200 nits, cámara 50MP Sony LYTIA OIS, 5000mAh TurboPower 68W, IP68, Gorilla Glass 5. $949,900 COP. 0% CMR. Envío gratis.',
    discountPercent: 59, originalPrice: 618.00, discountedPrice: 256.00,
    validFrom: addDays(NOW, -3), validUntil: addDays(NOW, 10),
    sourceUrl: 'https://www.falabella.com.co/falabella-co/search?Ntt=motorola+edge+60+fusion+5g',
  ...
  },
  {
    ...
    description: 'A16 Bionic, Dynamic Island, 48MP OIS + ultrawide 12MP, USB-C, Face ID, OLED 6.1", IP68. $2,879,100 COP. CMR 0% hasta 24 cuotas. Garantía Apple 12 meses Colombia.',
  ...
  },
  {
    ...
    description: 'Chip M2 8 CPU+8 GPU, 8GB RAM, 256GB SSD, Liquid Retina 13.6" True Tone, MagSafe 3, 18h batería, 1.24kg. $4,499,000 COP. Envío gratis. Garantía Apple 12 meses.',
  ...
  },
  {
    ...
    description: '30W JBL Pro Sound, 20h batería con banco USB integrado, IP67 sumergible, PartyBoost, Bluetooth 5.3. $227,435 COP. Antes $349,900 COP. 4.8 estrellas. Envío gratis.',
  ...
  },
  {
    ...
    description: 'ULED 4K 144Hz VRR, Quantum Dot 100% DCI-P3, Dolby Vision IQ + HDR10+ Adaptive, MEMC, Google TV, audio 20W Dolby Atmos. $1,499,900 COP. Antes $2,299,900. Envío gratis.',
  ...
  },
  {
    ...
    description: 'Motor Direct Drive silencioso 10 años garantía, Steam higieniza, TurboWash360 en 39min, A++ eficiencia, 14 programas. $1,119,200 COP. Antes $1,399,000. Envío + instalación gratis.',
  ...
  },
  {
    ...
    description: 'Twin Cooling Plus, compresor Digital Inverter, convertible 5 modos, panel personalizable 3 colores, display digital exterior. $1,499,000 COP. Antes $1,999,000. Garantía Samsung 5 años compresor.',
  ...
  },
  {
    ...
    description: 'Intel Core i5-1235U hasta 4.4GHz, 8GB DDR4, 512GB SSD NVMe, pantalla FHD 15.6" IPS anti-reflejo, WiFi 6. $1,249,000 COP. Antes $1,599,000. Garantía ASUS 12 meses. Windows 11 Home.',
  ...
  },
  {
    ...
    description: 'Exynos 1380 5nm, AMOLED 6.6" 120Hz, triple cámara 50MP OIS, batería 5000mAh 25W, IP67, Android 14. $799,000 COP. Antes $999,000. 4.6 estrellas. Envío gratis.',
  ...
  },
  {
    ...
    description: '8 micrófonos + V1+QN1 — ANC de referencia, 30h batería, carga 3min=60min, LDAC, Multipoint 2 dispositivos. $899,000 COP. Antes $1,199,000. CMR 0% hasta 12 cuotas.',

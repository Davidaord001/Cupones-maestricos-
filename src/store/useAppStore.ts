...
const defaultDiscounts: Omit<import('./types').Discount, never>[] = [
...

  {
    ...
    description: 'Exynos 2500 3nm, Dynamic AMOLED 2X 6.7" 120Hz 2600 nits, cámara 50MP OIS + tele 3×, batería 4700mAh 45W, IP68. 0% interés + Envío gratis.',
    discountPercent: 12, originalPrice: 4545000, discountedPrice: 3999990,
  ...
  },
  {
    ...
    description: 'Dimensity 7300 Energy 5G 4nm, pOLED 6.67" 144Hz 1200 nits, cámara 50MP Sony LYTIA OIS, 5000mAh TurboPower 68W, IP68, Gorilla Glass 5. 0% CMR. Envío gratis.',
    discountPercent: 10, originalPrice: 999900, discountedPrice: 899900,
  ...
  },
  {
    ...
    description: 'A16 Bionic, Dynamic Island, 48MP OIS + ultrawide 12MP, USB-C, Face ID, OLED 6.1", IP68. CMR 0% hasta 24 cuotas.',
    discountPercent: 10, originalPrice: 3199000, discountedPrice: 2879100,
    validFrom: addDays(NOW, -5), validUntil: addDays(NOW, 20),
  ...
  },
  {
    ...
    description: 'Chip M2 8 CPU+8 GPU, 8GB RAM, 256GB SSD, Liquid Retina 13.6" True Tone, MagSafe 3, 18h batería, 1.24kg. Garantía Apple 12 meses.',
    discountPercent: 10, originalPrice: 4999000, discountedPrice: 4499000,
    validFrom: addDays(NOW, -4), validUntil: addDays(NOW, 16),
  ...
  },
  {
    ...
    description: '30W JBL Pro Sound, 20h batería con banco USB integrado, IP67 sumergible, PartyBoost, Bluetooth 5.3. Envío gratis.',
    discountPercent: 35, originalPrice: 349900, discountedPrice: 227435,
  ...
  },
  {
    ...
    description: 'Snapdragon 7s Gen 2 4nm, cámara 200MP OIS, carga 120W (50% en 11min), AMOLED 6.67" 120Hz 1800 nits, IP68. Envío gratis.',
    discountPercent: 28, originalPrice: 1399000, discountedPrice: 999900,
    validFrom: addDays(NOW, -4), validUntil: addDays(NOW, 16),
  ...
  },
  {
    ...
    description: 'ULED 4K 144Hz VRR, Quantum Dot 100% DCI-P3, Dolby Vision IQ + HDR10+ Adaptive, MEMC, Google TV, 20W Dolby Atmos. Envío gratis.',
    discountPercent: 35, originalPrice: 2299900, discountedPrice: 1499900,
  ...
  },
  {
    ...
    description: 'Motor Direct Drive garantía 10 años, Steam higieniza, TurboWash360 en 39min, A++ eficiencia. Envío + instalación gratis.',
    discountPercent: 20, originalPrice: 1399000, discountedPrice: 1119200,
  ...
  },
  {
    ...
    description: 'Twin Cooling Plus, compresor Digital Inverter, convertible 5 modos, panel personalizable 3 colores. Garantía Samsung 5 años compresor.',
    discountPercent: 25, originalPrice: 1999000, discountedPrice: 1499000,
  ...
  },
  {
    ...
    description: 'Intel Core i5-1235U hasta 4.4GHz, 8GB DDR4, 512GB SSD NVMe, pantalla FHD 15.6" IPS. Windows 11 Home. Garantía ASUS 12 meses.',
    discountPercent: 22, originalPrice: 1599000, discountedPrice: 1249000,
  ...
  },
  {
    ...
    description: 'Exynos 1380 5nm, AMOLED 6.6" 120Hz, triple cámara 50MP OIS, 5000mAh 25W, IP67. Android 14. Envío gratis.',
    discountPercent: 20, originalPrice: 999000, discountedPrice: 799000,
    validFrom: addDays(NOW, -4), validUntil: addDays(NOW, 18),

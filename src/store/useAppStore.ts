...
const defaultDiscounts: Omit<import('./types').Discount, never>[] = [
  ...
  // ─── TECH / ELECTRÓNICA — productos REALES verificados (Artefacta + Comandato) ─────
  {
    ...
    imageUrl: 'https://www.artefacta.com/media/catalog/product/1/5/153602-1_1.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=400&width=400&canvas=400:400&format=jpeg',
  ...
  },
  {
    ...
    imageUrl: 'https://www.artefacta.com/media/catalog/product/1/5/155036_1.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=400&width=400&canvas=400:400',
    detectedAt: NOW.toISOString(), predictedDiscount: false, confidence: 99, sector: 'Electrónica',
    country: 'Ecuador', freeShipping: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.artefacta.com/media/catalog/product/1/5/159413-7_3.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=400&width=400&canvas=400:400',
    detectedAt: NOW.toISOString(), predictedDiscount: false, confidence: 99, sector: 'Electrónica',
    country: 'Ecuador', freeShipping: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.artefacta.com/media/catalog/product/1/5/156572_3_.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=400&width=400&canvas=400:400',
    detectedAt: NOW.toISOString(), predictedDiscount: false, confidence: 99, sector: 'Electrónica',
    country: 'Ecuador', freeShipping: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.artefacta.com/media/catalog/product/1/5/158723_00.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=400&width=400&canvas=400:400',
    detectedAt: NOW.toISOString(), predictedDiscount: false, confidence: 99, sector: 'Electrónica',
    country: 'Ecuador', freeShipping: true,
  ...
  },
  {
    ...
    imageUrl: 'https://www.artefacta.com/media/catalog/product/1/5/154283_00.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=400&width=400&canvas=400:400',
    detectedAt: NOW.toISOString(), predictedDiscount: false, confidence: 97, sector: 'Electrónica',
